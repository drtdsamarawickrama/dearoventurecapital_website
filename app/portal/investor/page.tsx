  ...
  return (
    <main className="application-page">
      ...
      <section className="application-container">
        ...
        {/* Heading */}
        <h1>
          Apply as an <span>Investor</span>
        </h1>

        {/* Description */}
        <p className="application-description">
          Join Dearo as an investor and explore opportunities
          to grow your investment with us.
        </p>
        ...
        <div className="account-box">
          ...
          <p>
            To continue with your investor application,
          ...
          >
            Continue Fill Investor Application
            <ArrowRight size={18} />
          </button>
        ...
        <p className="bottom-text">
          ...
          fill your investor application.
        </p>
